...
const techIcons = [
  ...
  { name: "Next.js", color: "var(--color-fg)", svg: (
    <svg viewBox="0 0 24 24" className="w-9 h-9" fill="currentColor">
  ...
  { name: "Supabase", color: "#3ECF8E", svg: (
    <svg viewBox="0 0 24 24" className="w-9 h-9" fill="currentColor">
  ...
  { name: "PostgreSQL", color: "#4169E1", svg: (
    <svg viewBox="0 0 24 24" className="w-9 h-9" fill="currentColor">
...
export default function TechStack() {
  return (
    <section id="teknologi" className="py-20 md:py-24 relative overflow-hidden">
      <div className="section-divider absolute top-0 inset-x-0" />

      {/* Ambient background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-gradient-to-tr from-[#8B5CF6]/15 to-[#0EA5E9]/15 rounded-full blur-[140px] pointer-events-none -z-10" />
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8">
        <motion.div {...fadeUp(0)} className="text-center mb-14">
          ...
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-fg mb-4">
            Teknologi yang <span className="gradient-text">Kami Kuasai</span>
          </h2>
          <p className="text-fg-muted max-w-2xl mx-auto text-base sm:text-lg font-light">
            Menggunakan teknologi modern dan teruji untuk memastikan performa, keamanan, dan skalabilitas jangka panjang.
          </p>
        </motion.div>

        {/* Marquee container — mask fades content edges seamlessly */}
        <div
        ...
        >
          {/* Marquee track */}
          <div
            className="flex gap-5 w-max py-3 hover:[animation-play-state:paused]"
            style={{ animation: "marquee-left 30s linear infinite" }}
          >
            {[...techIcons, ...techIcons, ...techIcons].map((tech, i) => (
              <div
                key={`${tech.name}-${i}`}
                className="group relative flex items-center gap-3 px-5 py-3.5 rounded-xl bg-pill border border-bd hover:border-[#8B5CF6]/40 hover:bg-pill-hover transition-all duration-300 shrink-0 cursor-pointer overflow-hidden"
              >
                {/* Brand Color Subtle Glow Background */}
                <div
                ...
                <div
                  className="transition-all duration-300 group-hover:scale-110 relative z-10 shrink-0"
                  style={{ color: tech.color }}
                >
                  {tech.svg}
                </div>

                <span className="text-sm font-semibold text-fg-muted group-hover:text-fg transition-colors duration-300 tracking-wide relative z-10 whitespace-nowrap">
                  {tech.name}
                </span>
              </div>
            ))}
